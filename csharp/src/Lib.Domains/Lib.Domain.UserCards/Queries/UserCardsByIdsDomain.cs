...
/// </summary>
internal sealed class UserCardsByIdsDomain : IUserCardsByIdsDomain
{
    private readonly IUserCardsQueryAggregatorService _userCardsAggregatorService;

    public UserCardsByIdsDomain(ILogger logger) : this(new UserCardsAggregatorService(logger))
    { }

    private UserCardsByIdsDomain(IUserCardsQueryAggregatorService userCardsAggregatorService) => _userCardsAggregatorService = userCardsAggregatorService;
