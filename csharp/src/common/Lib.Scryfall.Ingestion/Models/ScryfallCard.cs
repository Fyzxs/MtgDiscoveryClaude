...
internal sealed class ScryfallCard : IScryfallCard
{
    ...
    {
        if (imageUris.small != null)
            imageInfos.Add(new CardImageInfo(this, side, "small", (string)imageUris.small));
        if (imageUris.normal != null)
            imageInfos.Add(new CardImageInfo(this, side, "normal", (string)imageUris.normal));
        if (imageUris.large != null)
            imageInfos.Add(new CardImageInfo(this, side, "large", (string)imageUris.large));
        if (imageUris.art_crop != null)
            imageInfos.Add(new CardImageInfo(this, side, "art_crop", (string)imageUris.art_crop));
        if (imageUris.border_crop != null)
            imageInfos.Add(new CardImageInfo(this, side, "border_crop", (string)imageUris.border_crop));
    }
