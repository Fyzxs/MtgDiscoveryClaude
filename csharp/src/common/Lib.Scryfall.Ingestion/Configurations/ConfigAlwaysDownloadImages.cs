...
internal sealed class ConfigAlwaysDownloadImages : AlwaysDownloadImages
{
    private readonly string _sourceKey;
    private readonly IConfig _config;

    public ConfigAlwaysDownloadImages(string sourceKey, IConfig config)
    {
    ...
    public override bool AsSystemType()
    {
        ...
        if (bool.TryParse(value, out bool parsed) is false)
