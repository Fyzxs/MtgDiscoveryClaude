...
internal sealed class CardsByArtistSuccessDataResponseModelType : ObjectType<SuccessDataResponseModel<List<CardItemOutEntity>>>
{
    ...
    {
        descriptor.Name("CardsByArtistSuccessResponse")
            .Description("Response returned when cards by artist are successfully retrieved");
