...
internal sealed class HasValidTargetUserIdGrantCollectionAccessArgEntityValidator : OperationResponseValidator<IGrantCollectionAccessArgEntity, IGrantCollectionAccessItrEntity>
{
    public HasValidTargetUserIdGrantCollectionAccessArgEntityValidator() : base(new Validator(), new Message())
    { }
