...
internal sealed class CreateCollectionNameUniquenessValidator : ICreateCollectionNameUniquenessValidator
{
        ...
        ICreateCollectionArgsEntity args)
    {
        ...
        bool nameExists = collections.Any(c =>
            string.Equals(c.Name, args.CreateCollection.Name, StringComparison.OrdinalIgnoreCase));
