...
internal sealed class UserSetCardExtToOufMapper : IUserSetCardExtToOufMapper
{
    private readonly IUserSetCardGroupExtToOufMapper _groupMapper;
    private readonly IUserSetCardCollectingExtToOufMapper _collectingMapper;

    public UserSetCardExtToOufMapper() : this(new UserSetCardGroupExtToOufMapper(), new UserSetCardCollectingExtToOufMapper())
    { }

    private UserSetCardExtToOufMapper(IUserSetCardGroupExtToOufMapper groupMapper, IUserSetCardCollectingExtToOufMapper collectingMapper)
    {
