...
internal sealed class CollectionSetItemExtToOufMapper : CollectionCreateMapper<ScryfallSetItemExtEntity, ISetItemItrEntity>, ICollectionSetItemExtToOufMapper
{
