...
internal sealed class CardNameSearchAggregatorServiceFake : ICardNameSearchAggregatorService
{
    ...
    public Task<IOperationResponse<ICardNameSearchCollectionOufEntity>> Execute(ICardSearchTermItrEntity input)
    {
        ExecuteInvokeCount++;
