...
internal sealed class ArtistNameTrigramsCosmosContainerDefinition : ICosmosContainerDefinition
{
    ...
    public CosmosContainerName ContainerName() => new ArtistNameTrigramsCosmosContainerName();
