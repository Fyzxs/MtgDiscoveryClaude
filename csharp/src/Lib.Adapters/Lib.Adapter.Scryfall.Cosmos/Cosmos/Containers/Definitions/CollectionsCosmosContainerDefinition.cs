...
internal sealed class CollectionsCosmosContainerDefinition : ICosmosContainerDefinition
{
    ...
    public CosmosContainerName ContainerName() => new CollectionsCosmosContainerName();
