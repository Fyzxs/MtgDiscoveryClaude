...
public sealed class RemoveUserWishlistCardAdapterFake : IRemoveUserWishlistCardAdapter
{
    ...
    public IRemoveUserWishlistCardXfrEntity? LastExecuteInput { get; private set; }

    public Task<IOperationResponse<UserWishlistCardExtEntity>> Execute(
        IRemoveUserWishlistCardXfrEntity input,
