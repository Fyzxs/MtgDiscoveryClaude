...
internal sealed class RenameCollectionXfrToReadPointMapper : IRenameCollectionXfrToReadPointMapper
{
    public Task<ReadPointItem> Map(IRenameCollectionXfrEntity source)
    {
