...
internal sealed class UpdateVisibilityXfrToReadPointMapper : IUpdateVisibilityXfrToReadPointMapper
{
    public Task<ReadPointItem> Map(IUpdateCollectionVisibilityXfrEntity source)
    {
