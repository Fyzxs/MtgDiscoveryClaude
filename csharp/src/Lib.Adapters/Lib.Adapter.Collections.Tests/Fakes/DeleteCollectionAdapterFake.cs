...
public sealed class DeleteCollectionAdapterFake : IDeleteCollectionAdapter
{
    ...
    public IDeleteCollectionXfrEntity? LastExecuteInput { get; private set; }

    public Task<IOperationResponse<CollectionExtEntity>> Execute(
        IDeleteCollectionXfrEntity input,
