...
public sealed class RevokeCollectionAccessAdapterFake : IRevokeCollectionAccessAdapter
{
    ...
    public IRevokeCollectionAccessXfrEntity? LastExecuteInput { get; private set; }

    public Task<IOperationResponse<CollectionExtEntity>> Execute(
        IRevokeCollectionAccessXfrEntity input,
