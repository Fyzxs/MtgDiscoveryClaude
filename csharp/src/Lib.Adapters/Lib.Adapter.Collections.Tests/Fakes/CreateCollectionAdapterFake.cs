...
public sealed class CreateCollectionAdapterFake : ICreateCollectionAdapter
{
    ...
    public ICollectionXfrEntity? LastExecuteInput { get; private set; }

    public Task<IOperationResponse<CollectionExtEntity>> Execute(
        ICollectionXfrEntity input,
