...
public sealed class DatabaseFake : Database
{
    ...
    public ContainerProperties CapturedContainerProperties { get; private set; }

    public ContainerResponse CreateContainerIfNotExistsAsyncWithThroughputResult { get; init; }
    public int CreateContainerIfNotExistsAsyncWithThroughputInvokeCount { get; private set; }
    public ThroughputProperties CapturedContainerThroughputProperties { get; private set; }
    ...
    {
        CreateContainerIfNotExistsAsyncWithThroughputInvokeCount++;
        CapturedContainerProperties = containerProperties;
        CapturedContainerThroughputProperties = throughputProperties;
        return Task.FromResult(CreateContainerIfNotExistsAsyncWithThroughputResult);
    }
    ...
    public override Task<ContainerResponse> CreateContainerIfNotExistsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        CreateContainerIfNotExistsAsyncInvokeCount++;
        CapturedContainerProperties = containerProperties;
        return Task.FromResult(CreateContainerIfNotExistsAsyncResult);
    }
