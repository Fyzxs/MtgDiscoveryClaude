...
All properties require an attribute showing if it's serialized out, or ignored. Any type that is inherited MUST define the attribute for any property and the derived class MUST NOT re-define the serialization behavior.
