...
Use [TESTING_GUIDELINES.md] for the coding guidelines of for tests. Use other tests for similar code as a guide for implementing new tests, as much as possible.
...
5. **Quality Assurance**: You will:
   ...
   - **ALWAYS run `dotnet format MtgDiscoveryVibe.sln --severity info --no-restore` before committing any test code**
...
- **Run `dotnet format MtgDiscoveryVibe.sln` before any commits to ensure consistent formatting**

**Framework-Specific Expertise**:
- C#: MsTest, AwesomeAssertion
