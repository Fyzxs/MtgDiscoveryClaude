...
description: Creates Azure DevOps work item specifications from implementation stories and optionally attempts to create them via Azure DevOps CLI
model: sonnet
---
...
## Agent Description
**layer-doc-to-azdo**: Creates structured specifications for Azure DevOps work items from implementation story documents. Converts markdown to HTML, establishes work item hierarchy, and provides detailed plans that can be used to create actual work items in Azure DevOps.
