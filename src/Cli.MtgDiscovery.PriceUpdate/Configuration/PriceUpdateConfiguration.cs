...
internal sealed class PriceUpdateConfiguration
{
    ...
    public int MaxConcurrentOperations { get; init; } = 3;
    public int DelayBetweenOperationsMs { get; init; } = 100;
    public int MaxRuPerSecond { get; init; } = 5000;
    public int CosmosRetryCount { get; init; } = 5;
    public int CosmosRetryDelayMs { get; init; } = 1000;
