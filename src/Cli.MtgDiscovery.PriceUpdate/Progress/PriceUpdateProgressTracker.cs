...
internal sealed class PriceUpdateProgressTracker : IPriceUpdateProgressTracker
{
    ...
    public void Initialize(int totalRecords)
    {
        ...
        _currentProgress = 0;
        Console.WriteLine($"Starting price update of {_totalRecords} records...");
        DisplayProgress();
    }
    ...
    {
        Console.WriteLine();
        Console.WriteLine($"Price update complete: {_currentProgress}/{_totalRecords} records processed.");
    }
