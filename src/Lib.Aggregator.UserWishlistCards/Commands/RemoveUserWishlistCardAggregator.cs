...
internal sealed class RemoveUserWishlistCardAggregator : IRemoveUserWishlistCardAggregator
{
    ...
    private static RemoveUserWishlistCardXfrEntity MapItrToXfr(IUserWishlistCardItrEntity itr)
    {
        return new RemoveUserWishlistCardXfrEntity
        {
            UserId = itr.UserId,
            CardId = itr.CardId,
    ...
    private sealed class RemoveUserWishlistCardXfrEntity : IRemoveUserWishlistCardXfrEntity
    {
