...
internal sealed class CardAdapterServiceFake : ICardAdapterService
{
    ...
    public IOperationResponse<IEnumerable<ScryfallSetCardItemExtEntity>> GetCardsBySetCodeAsyncResult { get; init; } = new SuccessOperationResponse<IEnumerable<ScryfallSetCardItemExtEntity>>([]);
    ...
    public IOperationResponse<IEnumerable<ScryfallCardByNameExtEntity>> GetCardsByNameAsyncResult { get; init; } = new SuccessOperationResponse<IEnumerable<ScryfallCardByNameExtEntity>>([]);
    ...
    public IOperationResponse<IEnumerable<string>> SearchCardNamesAsyncResult { get; init; } = new SuccessOperationResponse<IEnumerable<string>>([]);
