...
internal sealed class CardNameTrigramsCosmosContainerDefinition : ICosmosContainerDefinition
{
    ...
    public CosmosContainerName ContainerName() => new CardNameTrigramsCosmosContainerName();
