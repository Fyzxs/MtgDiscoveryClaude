...
internal sealed class UserSetCardsCosmosContainerDefinition : ICosmosContainerDefinition
{
    ...
    public CosmosContainerName ContainerName() => new UserSetCardsCosmosContainerName();
