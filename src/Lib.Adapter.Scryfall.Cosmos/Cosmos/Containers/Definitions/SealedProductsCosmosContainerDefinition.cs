...
internal sealed class SealedProductsCosmosContainerDefinition : ICosmosContainerDefinition
{
    ...
    public CosmosContainerName ContainerName() => new SealedProductItemsCosmosContainerName();
