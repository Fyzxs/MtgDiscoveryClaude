...
internal sealed class UserWishlistCardsCosmosContainerDefinition : ICosmosContainerDefinition
{
    ...
    public CosmosContainerName ContainerName() => new UserWishlistCardsCosmosContainerName();
