...
internal sealed class SetArtistsCosmosContainerDefinition : ICosmosContainerDefinition
{
    ...
    public CosmosContainerName ContainerName() => new SetArtistsCosmosContainerName();
