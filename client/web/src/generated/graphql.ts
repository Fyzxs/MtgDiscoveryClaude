...
/** Input for querying all sets */
export type AllSetsInput = {
...
export type ApiMutationCreateCollectionArgs = {
  args?: InputMaybe<CreateCollectionInput>;
};


export type ApiMutationDeleteCollectionArgs = {
  args?: InputMaybe<DeleteCollectionInput>;
};


export type ApiMutationGrantCollectionAccessArgs = {
  args?: InputMaybe<GrantCollectionAccessInput>;
};


export type ApiMutationRenameCollectionArgs = {
  args?: InputMaybe<RenameCollectionInput>;
};


export type ApiMutationRevokeCollectionAccessArgs = {
  args?: InputMaybe<RevokeCollectionAccessInput>;
};


export type ApiMutationTransferCollectionOwnershipArgs = {
  args?: InputMaybe<TransferCollectionOwnershipInput>;
};


export type ApiMutationUpdateCollectionVisibilityArgs = {
  args?: InputMaybe<UpdateCollectionVisibilityInput>;
};
...
export type ApiQueryAllSetsArgs = {
  args?: InputMaybe<AllSetsInput>;
};


export type ApiQueryArtistSearchArgs = {
  searchTerm?: InputMaybe<ArtistSearchTermInput>;
};


export type ApiQueryCardNameSearchArgs = {
  searchTerm?: InputMaybe<CardSearchTermInput>;
};


export type ApiQueryCardsByArtistArgs = {
  artistId?: InputMaybe<ArtistIdInput>;
};


export type ApiQueryCardsByArtistNameArgs = {
  artistName?: InputMaybe<ArtistNameInput>;
};


export type ApiQueryCardsByIdArgs = {
  ids?: InputMaybe<CardIdsInput>;
};


export type ApiQueryCardsByNameArgs = {
  cardName?: InputMaybe<CardNameInput>;
};


export type ApiQueryCardsBySetCodeArgs = {
  setCode?: InputMaybe<SetCodeInput>;
};
...
export type ApiQuerySealedProductsBySetCodeArgs = {
  args?: InputMaybe<GetSealedProductsBySetCodeInput>;
};


export type ApiQuerySetsByCodeArgs = {
  codes?: InputMaybe<SetCodesInput>;
};


export type ApiQuerySetsByIdArgs = {
  ids?: InputMaybe<SetIdsInput>;
};
...
/** Input for querying cards by artist ID */
export type ArtistIdInput = {
...
/** Input for querying cards by artist name */
...
/** Input for searching artists by search term */
export type ArtistSearchTermInput = {
  /** The search term to use for artist search */
...
/** Input for querying cards by card IDs */
export type CardIdsInput = {
...
/** Input for querying cards by card name */
export type CardNameInput = {
  /** The card name to query */
...
/** Input for searching cards by search term */
export type CardSearchTermInput = {
  /** The search term to use for card search */
  searchTerm: Scalars['String']['input'];
};
...
export type CreateCollectionInput = {
  ...
  /** The visibility of the collection (public/private) */
...
/** Input for querying sealed products by set code */
export type GetSealedProductsBySetCodeInput = {
  /** The unique identifier of the collection */
  collectionId: Scalars['String']['input'];
  /** The set code to query sealed products for */
  setCode: Scalars['String']['input'];
  /** The unique identifier of the user */
  userId: Scalars['String']['input'];
};

/** Input for granting collection access to a user */
export type GrantCollectionAccessInput = {
  /** The unique identifier of the collection */
  collectionId: Scalars['String']['input'];
  /** The role to assign (viewer/editor/owner) */
  role: Scalars['String']['input'];
  /** The unique identifier of the user to grant access to */
...
/** Input for revoking collection access from a user */
export type RevokeCollectionAccessInput = {
  /** The unique identifier of the collection */
  collectionId: Scalars['String']['input'];
...
/** Input for querying cards by set code */
export type SetCodeInput = {
  /** The set code to query */
  setCode: Scalars['String']['input'];
  /** The unique identifier of the user */
  userId: Scalars['String']['input'];
};

/** Input for querying sets by set codes */
export type SetCodesInput = {
  /** The collection of set codes to query */
  setCodes: Array<Scalars['String']['input']>;
  /** The unique identifier of the user */
  userId: Scalars['String']['input'];
};
...
/** Input for querying sets by set IDs */
export type SetIdsInput = {
  /** The collection of set IDs to query */
  setIds: Array<Scalars['String']['input']>;
  /** The unique identifier of the user */
  userId: Scalars['String']['input'];
};
...
/** Input for transferring collection ownership */
export type TransferCollectionOwnershipInput = {
  /** The unique identifier of the collection */
  collectionId: Scalars['String']['input'];
  /** The unique identifier of the user to transfer ownership to */
  targetUserId: Scalars['String']['input'];
};

/** Input for updating collection visibility */
export type UpdateCollectionVisibilityInput = {
  /** The unique identifier of the collection */
  collectionId: Scalars['String']['input'];
  /** The new visibility level (public/private) */
  visibility: Scalars['String']['input'];
};
...
export type ArtistSearchQueryVariables = Exact<{
  searchTerm: ArtistSearchTermInput;
}>;
...
export type CardNameSearchQueryVariables = Exact<{
  searchTerm: CardSearchTermInput;
}>;
...
export type GetSealedProductsBySetCodeQueryVariables = Exact<{
  args: GetSealedProductsBySetCodeInput;
}>;
...
export type GetUserWishlistQuery = { __typename?: 'ApiQuery', userWishlist?: { __typename: 'CardsSuccessResponse', data?: Array<{ __typename?: 'Card', id: string, name?: string | null, releasedAt?: string | null, setId?: string | null, setCode?: string | null, setName?: string | null, artist?: string | null, artistIds?: Array<string | null> | null, collectorNumber?: string | null, rarity?: string | null, contentWarning?: boolean | null, foil?: boolean | null, nonFoil?: boolean | null, finishes?: Array<string | null> | null, scryfallUri?: string | null, imageUris?: { __typename?: 'ImageUris', small?: string | null, normal?: string | null, large?: string | null, png?: string | null, artCrop?: string | null, borderCrop?: string | null } | null, cardFaces?: Array<{ __typename?: 'CardFace', name?: string | null, imageUris?: { __typename?: 'ImageUris', small?: string | null, normal?: string | null, large?: string | null, png?: string | null, artCrop?: string | null, borderCrop?: string | null } | null } | null> | null, prices?: { __typename?: 'Prices', usd?: string | null, usdFoil?: string | null, usdEtched?: string | null } | null, purchaseUris?: { __typename?: 'PurchaseUris', tcgplayer?: string | null } | null, userWishlist?: Array<{ __typename?: 'WishlistItem', finish: string, special: string, count: number } | null> | null } | null> | null } | { __typename: 'FailureResponse', status?: { __typename?: 'StatusData', message?: string | null, statusCode?: number | null } | null } | null };
