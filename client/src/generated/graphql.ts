...
export type ApiQuery = {
  ...
  userWishlist?: Maybe<UserWishlistResponseModel>;
};
...
export type GetUserWishlistQuery = { __typename?: 'ApiQuery', userWishlist?: { __typename: 'FailureResponse', status?: { __typename?: 'StatusData', message?: string | null, statusCode?: number | null } | null } | { __typename: 'UserWishlistSuccessDataResponseModel', data: Array<{ __typename?: 'UserWishlistCard', userId: string, cardId: string, setId: string, cardName: string, setName: string, setCode: string, artistIds: Array<string>, cardNameGuid: string, createdAt: string, updatedAt: string, wishlistItems: Array<{ __typename?: 'WishlistItem', finish: string, special: string, count: number }> }> } | null };
