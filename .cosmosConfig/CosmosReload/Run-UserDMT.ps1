# Run DMT for User-related configurations only
# This script runs the DMT tool for UserCards and UserSetCards

$dmtPath = "$PSScriptRoot\.dmt\dmt.exe"

$userFiles = @(
    "dmt-UserCards.json",
    "dmt-UserSetCards.json"
)

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Running DMT for USER configurations" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
