# Run DMT for Sets-related configurations only
# This script runs the DMT tool for SetItems and SetCards
...
Write-Host "Running DMT for SETS configurations" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$successCount = 0
$failCount = 0
$totalCount = $setsFiles.Count

foreach ($fileName in $setsFiles) {
